    ...
    mutations: {
        ...
        setError: (state, error) => {
            ...
            const errors = {
                ...
                'auth/user-not-found': 'Usuário e/ou senha inválido(s).',
                ...
                'auth/wrong-password': 'Usuário e/ou senha inválido(s)',
            ...
            state.error = !!errors[error] ? errors[error] : 'Erro não catalogado - ' + error
        },
    },
    modules: {},
})

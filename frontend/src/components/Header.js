...
export default function Header() {
  ...
  const navigation = [
    {
      name: 'WhatsApp',
      href: 'https://api.whatsapp.com/send/?phone=5514997065191&text&type=phone_number&app_absent=0',
      icon: <BsWhatsapp />
    },
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/armazemdvitto/',
      icon: <BsInstagram />
    },
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/ArmazemDVitto',
      icon: <BsFacebook />
    },
  ]
              ...
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex space-x-4">
                  ...
                  <a
                    target="_blank"
                    rel="noreferrer"
                    href="https://armazemdvitto.goomer.app/menu"
                    className="text-gray-300 hover:bg-black duration-150 hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                  >
                    Delivery
                  </a>
                  <a
                    target="_blank"
                    rel="noreferrer"
                    href="https://goo.gl/maps/JUqtNrkhJrVLVdq77"
                    className="text-gray-300 hover:bg-black duration-150 hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                  >
                    Localização
                  </a>
